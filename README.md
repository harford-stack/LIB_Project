...
📝 사용자 편의성에 중점을 두어 사용자가 최대한 쉽게 클릭만으로 예약할 수 있도록 구현했습니다.
...
#### 📌이메일, 연락처 정보 입력 시 사용자 편의성 고려하여 작성 안내
...
### 📝 4. 좌석 예약
#### 📌예약 날짜 선택 : 달력 제공 
#### 📌이용 시간 선택1 : 당일 예약 시 현재 시간 반영하여 현재 시간 이후 시간부터 예약 가능
#### 📌이용 시간 선택2 : 영업 시간 반영하여 선택 가능 시간 보여주기
#### 📌이용 시간 선택3 : 추후 확장 시 분 단위 선택 가능
#### 📌좌석 선택1 : 날짜와 시간 선택 시에 등장, 1인석 및 그룹실 제공
#### 📌좌석 선택2 : 좌석 구조 실제 위치 반영하여 안내, 기예약 좌석 예약 불가 표시
...
#### 📌예약 정보 확인1 : 모든 예약 확인 및 이미 사용되었거나 최소한 내역도 따로 보기 가능
